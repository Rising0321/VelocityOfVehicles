...
class DeepSort(object):
    def __init__(self, model_path, max_dist=0.15, min_confidence=0.3, nms_max_overlap=1.0, max_iou_distance=0.7,
    ...
    def _xyxy_to_xywh(self, bbox_xyxy):
        bbox_xywh = []
        for i in range(0, len(bbox_xyxy)):
